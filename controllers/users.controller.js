...
const ordersByUser = catchAsync(async (req, res, next) => {
	const { sessionUser } = req

	const orders = Orders.findAll({
		where: { userId: sessionUser.id, status: 'active' },
		// adjuntar el modelo del restaurante
	})
...
const ordersById = catchAsync(async (req, res, next) => {
	const { order } = req
...
// falta incluir los restaurantes al consultar las ordenes
module.exports = {
	getAllUsers,
	createUser,
	updateUser,
